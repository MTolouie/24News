...
namespace News_Web.Pages.Journalist.News
{
    public class PendingModel : PageModel
    {
        ...
        public PendingModel(ICategoryRepository categoryRepository, INewsRepository newsRepository, IUserRepository userRepository)
        {
        ...
        public async Task OnGet(int Category, int pageId = 1, string Title = "", string FromDate = "", string ToDate = "")
        {
            ...
            NewsDTO = await _newsRepository.GetUserPendingNews(user.Id, Category, pageId, Title, FromDate, ToDate);
