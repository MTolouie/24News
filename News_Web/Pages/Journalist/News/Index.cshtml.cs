...
namespace News_Web.Pages.Journalist.News
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ICategoryRepository categoryRepository, INewsRepository newsRepository, IUserRepository userRepository)
        {
        ...
        public async Task OnGet(int Category,int pageId = 1, string Title = "", string FromDate = "", string ToDate = "")
        {
            ...
            NewsDTO = await _newsRepository.GetAllUserNews(user.Id,Category,pageId, Title,FromDate, ToDate);
