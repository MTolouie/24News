...
namespace News_Web.Pages.Admin.News
{
    ...
    public class UnPublishedModel : PageModel
    {
        ...
        public UnPublishedModel(ICategoryRepository categoryRepository, INewsRepository newsRepository)
        {
        ...
        public async Task OnGet(int Category, int pageId = 1, string Title = "", string FromDate = "", string ToDate = "")
        {
            ...
            NewsDTO = await _newsRepository.GetAllUnPublishedNews(Category, pageId, Title, FromDate, ToDate);
