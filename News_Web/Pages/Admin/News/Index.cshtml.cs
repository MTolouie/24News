...
namespace News_Web.Pages.Admin.News
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ICategoryRepository categoryRepository, INewsRepository newsRepository)
        {
        ...
        public async Task OnGet(int Category,int pageId = 1, string Title = "", string FromDate = "", string ToDate = "")
        {
            ...
            NewsDTO = await _newsRepository.GetAllNews(Category,pageId, Title,FromDate, ToDate);
